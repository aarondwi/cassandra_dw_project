...
package skripsi.cobascd3cassandra_0_1;
...
/**
 * Job: cobascd3cassandra Purpose: coba scd 3 di cassandra<br>
 * Description: coba scd 3 di cassandra <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class cobascd3cassandra implements TalendJob {
	...
	private final String jobName = "cobascd3cassandra";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					cobascd3cassandra.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(cobascd3cassandra.this, new Object[] { e,
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				ArrayList<rollno_name> toUpdate = new ArrayList<rollno_name>();
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_SKRIPSI_cobascd3cassandra = new byte[0];
		static byte[] commonByteArray_SKRIPSI_cobascd3cassandra = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SKRIPSI_cobascd3cassandra.length) {
					if (length < 1024
							&& commonByteArray_SKRIPSI_cobascd3cassandra.length == 0) {
						commonByteArray_SKRIPSI_cobascd3cassandra = new byte[1024];
					} else {
						commonByteArray_SKRIPSI_cobascd3cassandra = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SKRIPSI_cobascd3cassandra, 0,
						length);
				strReturn = new String(
						commonByteArray_SKRIPSI_cobascd3cassandra, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SKRIPSI_cobascd3cassandra) {
	...
	public void tFileInputDelimited_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					while (fid_tFileInputDelimited_1 != null
						...
						if (row1 != null) {
							...
							((ArrayList<rollno_name>) globalMap.get("toUpdate"))
									.add(new rollno_name(row1.rollno,
											row1.new_name));
				...
				System.out.println(globalMap.get("rollno_to_check"));
	...
	public void tCassandraInput_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				com.datastax.driver.core.Cluster cluster_tCassandraInput_1 = com.datastax.driver.core.Cluster
						.builder()
				...
				com.datastax.driver.core.Session connection_tCassandraInput_1 = null;
				connection_tCassandraInput_1 = cluster_tCassandraInput_1
						.connect();
				...
				for (com.datastax.driver.core.Row row_tCassandraInput_1 : rs_tCassandraInput_1) {
					...
					if (row_tCassandraInput_1.isNull("\"start_date\"")) {
						...
						row2.start_date = row_tCassandraInput_1
					...
					if (row_tCassandraInput_1.isNull("\"end_date\"")) {
						...
						row2.end_date = row_tCassandraInput_1
					...
					ArrayList<rollno_name> toIterate = ((ArrayList<rollno_name>) globalMap
							.get("toUpdate"));
					for (int i = 0; i < toIterate.size(); i++) {
						if (row2.rollno == toIterate.get(i).getRollNo()) {
							((ArrayList<rollno_name>) globalMap.get("toUpdate"))
									.get(i).setPreviousNames(row2.name);
							break;
						}
					}
					nb_line_tJavaRow_1++;
				...
				globalMap.put("tCassandraInput_1_NB_LINE",
						nb_line_tCassandraInput_1);
				connection_tCassandraInput_1.close();
				cluster_tCassandraInput_1.close();
	...
	public void tJavaFlex_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				com.datastax.driver.core.Cluster cluster_tCassandraOutput_1 = com.datastax.driver.core.Cluster
						.builder()
						.addContactPoints("localhost".split(","))
						.withPort(Integer.valueOf("9042"))
				...
				com.datastax.driver.core.Session connection_tCassandraOutput_1 = null;
				connection_tCassandraOutput_1 = cluster_tCassandraOutput_1
						.connect();
				resourceMap.put("cluster_tCassandraOutput_1",
						cluster_tCassandraOutput_1);
				resourceMap.put("connection_tCassandraOutput_1",
				...
				prepareStmt_tCassandraOutput_1 = connection_tCassandraOutput_1
						.prepare("INSERT INTO "
								...
								+ " (rollno,name,\"previous_name\") VALUES (?,?,?)");
				...
				for (int i = 0; i < toIterate.size(); i++) {
					...
					// loop
					row3.rollno = toIterate.get(i).getRollNo();
					row3.name = toIterate.get(i).getName();
					row3.previous_name = toIterate.get(i).getPreviousName();
					...
					boundStmt_tCassandraOutput_1.setInt(0, row3.rollno);
					if (row3.name == null) {
						boundStmt_tCassandraOutput_1.setToNull(1);
					} else {
						boundStmt_tCassandraOutput_1.setString(1, row3.name);
					}
				...
				connection_tCassandraOutput_1.close();
				cluster_tCassandraOutput_1.close();
				resourceMap.put("finish_tCassandraOutput_1", true);
			...
			try {
				...
				if (resourceMap.get("finish_tCassandraOutput_1") == null) {
					if (resourceMap.get("connection_tCassandraOutput_1") != null) {
						((com.datastax.driver.core.Session) resourceMap
								.get("connection_tCassandraOutput_1")).close();
					}
					if (resourceMap.get("cluster_tCassandraOutput_1") != null) {
						((com.datastax.driver.core.Cluster) resourceMap
								.get("cluster_tCassandraOutput_1")).close();
					}
				}
	...
	public static void main(String[] args) {
		final cobascd3cassandra cobascd3cassandraClass = new cobascd3cassandra();

		int exitCode = cobascd3cassandraClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = cobascd3cassandra.class
					.getClassLoader().getResourceAsStream(
							"skripsi/cobascd3cassandra_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = cobascd3cassandra.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : cobascd3cassandra");
		}
...
/************************************************************************************************
 * 68019 characters generated by Talend Open Studio for Big Data on the July 18,
 * 2018 8:05:46 PM ICT
 ************************************************************************************************/
