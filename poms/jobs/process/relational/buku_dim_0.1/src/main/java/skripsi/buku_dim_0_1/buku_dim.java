...
public class buku_dim implements TalendJob {
	...
	public static class loadStruct implements
		...
		public Long kode_judul;

		public Long getKode_judul() {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SKRIPSI_buku_dim) {
				...
				try {
					...
					length = dis.readByte();
					if (length == -1) {
						this.kode_judul = null;
					} else {
						this.kode_judul = dis.readLong();
					}
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				if (this.kode_judul == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeLong(this.kode_judul);
				}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String insert_tDBOutput_1 = "INSERT INTO \""
						...
						+ "\" (\"kode_buku\",\"kode_judul\",\"judul\",\"kelompok_kategori\",\"penerbit\",\"jenis_terbitan\",\"nama_koleksi\",\"status_sekarang\") VALUES (?,?,?,?,?,?,?,?)";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							row4HashKey.kode_kategori = row3.k099a;
						...
						if (tHash_Lookup_row4 != null
							...
							// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row4' and it contains more one result from keys :  row4.kode_kategori = '"
							// + row4HashKey.kode_kategori + "'");
						} // G 071
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							row10HashKey.fnkd_jsntbt = row3.fnkd_jnstbt;
						...
						if (tHash_Lookup_row10 != null
							...
							// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row10' and it contains more one result from keys :  row10.fnkd_jsntbt = '"
							// + row10HashKey.fnkd_jsntbt + "'");
						} // G 071
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							row12HashKey.fckd_jnskol = row2.fckd_jnskol;
						...
						if (load != null) {
							...
							if (load.kode_buku == null) {
								...
								pstmt_tDBOutput_1.setString(1, load.kode_buku);
							}
							...
							if (load.kode_judul == null) {
								...
								pstmt_tDBOutput_1.setLong(2, load.kode_judul);
							}
							...
							if (load.judul == null) {
								...
								pstmt_tDBOutput_1.setString(3, load.judul);
							}
							...
							if (load.penerbit == null) {
								...
								pstmt_tDBOutput_1.setString(5, load.penerbit);
							}
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbquery_tDBInput_2 = "select * from penerbit";
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							row6.fnkd_penerbit = 0;
						} else {

							if (rs_tDBInput_2.getObject(1) != null) {
								row6.fnkd_penerbit = rs_tDBInput_2.getInt(1);
							} else {
						...
						if (colQtyInRs_tDBInput_2 < 2) {
							...
							row6.k260b = routines.system.JDBCUtil.getString(
				...
				try {
					...
					while (rs_tDBInput_5.next()) {
						...
						if (colQtyInRs_tDBInput_5 < 1) {
							row10.fnkd_jsntbt = null;
						} else {

							if (rs_tDBInput_5.getObject(1) != null) {
								row10.fnkd_jsntbt = rs_tDBInput_5.getLong(1);
							} else {
								row10.fnkd_jsntbt = null;
							}
						}
						if (colQtyInRs_tDBInput_5 < 2) {
							row10.fcket_jnstbt = null;
						} else {

							row10.fcket_jnstbt = routines.system.JDBCUtil
						...
						row10_HashRow.fnkd_jsntbt = row10.fnkd_jsntbt;

						row10_HashRow.fcket_jnstbt = row10.fcket_jnstbt;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					while (limittFileInputDelimited_1 != 0
						...
						if (row8 != null) {
							...
							row4.kode_kategori = row8.kode_kategori;
							row4.nama_kategori = row8.nama_kategori;
							...
							row4_HashRow.kode_kategori = row4.kode_kategori;

							row4_HashRow.nama_kategori = row4.nama_kategori;
				...
				for (int i_tFixedFlowInput_2 = 0; i_tFixedFlowInput_2 < 1; i_tFixedFlowInput_2++) {
					...
					row4.kode_kategori = row11.kode_kategori;
					row4.nama_kategori = row11.nama_kategori;
...
/************************************************************************************************
 * 260801 characters generated by Talend Open Studio for Big Data on the October
 * 16, 2018 11:25:06 AM ICT
 ************************************************************************************************/
