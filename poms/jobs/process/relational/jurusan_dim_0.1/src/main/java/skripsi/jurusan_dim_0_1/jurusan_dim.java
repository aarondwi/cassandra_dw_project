	...
	public void tFileInputDelimited_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				row2 = new row2Struct();
				row2.kode_jurusan = 900;
				row2.nama_jurusan = "Others";
				row2.fakultas = "Others";
				cacheList_tFixedFlowInput_1.add(row2);
...
/************************************************************************************************
 * 74124 characters generated by Talend Open Studio for Big Data on the October
 * 8, 2018 9:52:56 AM ICT
 ************************************************************************************************/
