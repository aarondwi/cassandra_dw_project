...
package skripsi.kategori_etl_0_1;
...
/**
 * Job: kategori_etl Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class kategori_etl implements TalendJob {
	...
	private final String jobName = "kategori_etl";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(kategori_etl.this, new Object[] { e,
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_SKRIPSI_kategori_etl = new byte[0];
		static byte[] commonByteArray_SKRIPSI_kategori_etl = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SKRIPSI_kategori_etl.length) {
					if (length < 1024
							&& commonByteArray_SKRIPSI_kategori_etl.length == 0) {
						commonByteArray_SKRIPSI_kategori_etl = new byte[1024];
					} else {
						commonByteArray_SKRIPSI_kategori_etl = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SKRIPSI_kategori_etl, 0, length);
				strReturn = new String(commonByteArray_SKRIPSI_kategori_etl, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SKRIPSI_kategori_etl) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				dbschema_tDBOutput_1 = "starschema";

				String tableName_tDBOutput_1 = null;
				if (dbschema_tDBOutput_1 == null
						|| dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "kategori_dimension";
				} else {
				...
				String url_tDBOutput_1 = "jdbc:postgresql://" + "" + ":"
						+ "5432" + "/" + "skripsi";
				dbUser_tDBOutput_1 = "skripsiuser";
				...
				String dbquery_tDBInput_1 = "select * from kategori";
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							if (rs_tDBInput_1.getObject(1) != null) {
								row1.k099a = rs_tDBInput_1.getInt(1);
							} else {
								row1.k099a = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 2) {
							row1.nama_kategori = null;
						} else {

							row1.nama_kategori = routines.system.JDBCUtil
						...
						if (row1.k099a == null) {
							...
							pstmt_tDBOutput_1.setInt(1, row1.k099a);
						}

						if (row1.nama_kategori == null) {
							pstmt_tDBOutput_1
									.setNull(2, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_1.setString(2, row1.nama_kategori);
						}
	...
	public static void main(String[] args) {
		final kategori_etl kategori_etlClass = new kategori_etl();

		int exitCode = kategori_etlClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = kategori_etl.class.getClassLoader()
					.getResourceAsStream(
							"skripsi/kategori_etl_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = kategori_etl.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : kategori_etl");
		}
...
/************************************************************************************************
 * 40615 characters generated by Talend Open Studio for Big Data on the August
 * 19, 2018 8:25:07 PM ICT
 ************************************************************************************************/
