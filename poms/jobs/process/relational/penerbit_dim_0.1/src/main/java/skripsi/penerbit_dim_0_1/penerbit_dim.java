...
package skripsi.penerbit_dim_0_1;
...
/**
 * Job: penerbit_dim Purpose: etl jurusan_dim<br>
 * Description: etl jurusan_dim <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class penerbit_dim implements TalendJob {
	...
	private final String jobName = "penerbit_dim";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(penerbit_dim.this, new Object[] { e,
	...
	public static class row3Struct implements
		...
		final static byte[] commonByteArrayLock_SKRIPSI_penerbit_dim = new byte[0];
		static byte[] commonByteArray_SKRIPSI_penerbit_dim = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SKRIPSI_penerbit_dim.length) {
					if (length < 1024
							&& commonByteArray_SKRIPSI_penerbit_dim.length == 0) {
						commonByteArray_SKRIPSI_penerbit_dim = new byte[1024];
					} else {
						commonByteArray_SKRIPSI_penerbit_dim = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SKRIPSI_penerbit_dim, 0, length);
				strReturn = new String(commonByteArray_SKRIPSI_penerbit_dim, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SKRIPSI_penerbit_dim) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null
					...
					tableName_tDBOutput_1 = "penerbit_dim";
				} else {
				...
				String dbquery_tDBInput_1 = "select * from penerbit";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							row1.fnkd_penerbit = 0;
						} else {

							if (rs_tDBInput_1.getObject(1) != null) {
								row1.fnkd_penerbit = rs_tDBInput_1.getInt(1);
							} else {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							row1.k260b = routines.system.JDBCUtil.getString(
						...
						row3.fnkd_penerbit = row1.fnkd_penerbit;
						row3.k260b = row1.k260b;
						...
						pstmt_tDBOutput_1.setInt(1, row3.fnkd_penerbit);

						if (row3.k260b == null) {
							pstmt_tDBOutput_1
									.setNull(2, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_1.setString(2, row3.k260b);
						}
				...
				for (int i_tFixedFlowInput_1 = 0; i_tFixedFlowInput_1 < 1; i_tFixedFlowInput_1++) {
					...
					row3.fnkd_penerbit = row2.k260b;
					row3.k260b = row2.fnkd_penerbit;
	...
	public static void main(String[] args) {
		final penerbit_dim penerbit_dimClass = new penerbit_dim();

		int exitCode = penerbit_dimClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = penerbit_dim.class.getClassLoader()
					.getResourceAsStream(
							"skripsi/penerbit_dim_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = penerbit_dim.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : penerbit_dim");
		}
...
/************************************************************************************************
 * 63320 characters generated by Talend Open Studio for Big Data on the
 * September 28, 2018 1:13:22 PM ICT
 ************************************************************************************************/
