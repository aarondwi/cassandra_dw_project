...
package skripsi.transaksi_fact_0_1;
...
/**
 * Job: transaksi_fact Purpose: etl usulan_fact<br>
 * Description: etl usulan_fact <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class transaksi_fact implements TalendJob {
	...
	private final String jobName = "transaksi_fact";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					transaksi_fact.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(transaksi_fact.this, new Object[] { e,
	...
	public static class loadStruct implements
		...
		final static byte[] commonByteArrayLock_SKRIPSI_transaksi_fact = new byte[0];
		static byte[] commonByteArray_SKRIPSI_transaksi_fact = new byte[0];

		public Long fntranscid;

		public Long getFntranscid() {
		...
		public Integer buku_dim_key;

		public Integer getBuku_dim_key() {
		...
		public Integer date_key_2;

		public Integer getDate_key_2() {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SKRIPSI_transaksi_fact) {
				...
				try {
					...
					length = dis.readByte();
					if (length == -1) {
						this.fntranscid = null;
					} else {
						this.fntranscid = dis.readLong();
					}
					...
					this.buku_dim_key = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				if (this.fntranscid == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeLong(this.fntranscid);
				}
				...
				writeInteger(this.buku_dim_key, dos);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null
					...
					tableName_tDBOutput_1 = "transaksi_fact";
				} else {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							if (rs_tDBInput_1.getObject(1) != null) {
								row1.fntranscid = rs_tDBInput_1.getLong(1);
							} else {
								row1.fntranscid = null;
							}
						}
						...
						// no change here
						row2.fntranscid = row1.fntranscid;
						row2.Denda = row1.Denda;
						row2.Terbayar = row1.Terbayar;
						row2.fckd_operator = row1.fckd_operator;
						row2.k999a = row1.k999a;

						SimpleDateFormat dt = new SimpleDateFormat("MM/dd/yyyy");
						// dt error here means wrong input data, e.g. 15:37.5 or
						// is null
						try {
							row2.fdtgl_pinjam = dt.parse(row1.fdtgl_pinjam
									.split(" ")[0]);
						} catch (Exception e) {
							row2.fdtgl_pinjam = null;
						}

						try {
							row2.fdtgl_batas = dt.parse(row1.fdtgl_batas
									.split(" ")[0]);
						} catch (Exception e) {
							row2.fdtgl_batas = null;
						}

						try {
							row2.fdtgl_kembali = dt.parse(row1.fdtgl_kembali
									.split(" ")[0]);
						} catch (Exception e) {
							row2.fdtgl_kembali = null;
						}

						// number only means a student
						if (row1.fckd_induk.matches("[0-9]+")
								&& row1.fckd_induk.length() == 8) {
							row2.fckd_induk = Integer.valueOf(row1.fckd_induk
									.substring(0, 3));
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							row3HashKey.tanggal = row2.fdtgl_pinjam;
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							row4HashKey.tanggal = row2.fdtgl_batas;
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							row6HashKey.tanggal = row2.fdtgl_kembali;
						...
						if (tHash_Lookup_row6 != null
							...
							// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row6' and it contains more one result from keys :  row6.tanggal = '"
							// + row6HashKey.tanggal + "'");
						} // G 071
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							row7HashKey.kode_jurusan = row2.fckd_induk;
						...
						if (tHash_Lookup_row7 != null
							...
							// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row7' and it contains more one result from keys :  row7.kode_jurusan = '"
							// + row7HashKey.kode_jurusan + "'");
						} // G 071
						...
						{ // start of Var scope
							...
							// # Output table : 'load'
							load_tmp.fntranscid = row2.fntranscid;
							load_tmp.Denda = row2.Denda;
							load_tmp.Terbayar = row2.Terbayar;
						...
						if (load != null) {
							...
							if (load.fntranscid == null) {
								pstmt_tDBOutput_1.setNull(1,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_1.setLong(1, load.fntranscid);
							}
							...
							if (load.Denda == null) {
								...
								pstmt_tDBOutput_1.setDouble(2, load.Denda);
							}

							if (load.Terbayar == null) {
								pstmt_tDBOutput_1.setNull(3,
										java.sql.Types.DOUBLE);
							} else {
								pstmt_tDBOutput_1.setDouble(3, load.Terbayar);
							}

							pstmt_tDBOutput_1.setInt(4, load.date_key);

							pstmt_tDBOutput_1.setInt(5, load.date_key_1);

							if (load.buku_dim_key == null) {
								pstmt_tDBOutput_1.setNull(6,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_1.setInt(6, load.buku_dim_key);
							}

							pstmt_tDBOutput_1.setInt(7, load.jurusan_key);

							if (load.date_key_2 == null) {
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// inputs:(row4) outputs:()
				// linked node: tMap_1 - inputs:(row2,row4,row5,row3,row6,row7)
				// outputs:(load)
	...
	public static class row5Struct implements
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.buku_dim_key = readInteger(dis, ois);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeInteger(this.buku_dim_key, dos, oos);
	...
	public void tDBInput_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbquery_tDBInput_5 = "select date_key,tanggal from date_dim";
				...
				try {
					...
					while (rs_tDBInput_5.next()) {
						...
						if (colQtyInRs_tDBInput_5 < 2) {
							...
							row6.tanggal = routines.system.JDBCUtil.getDate(
									rs_tDBInput_5, 2);
						}
						...
						row6_HashRow.tanggal = row6.tanggal;
	...
	public void tDBInput_6Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_6 - inputs:(after_tDBInput_1)
				...
				String dbquery_tDBInput_6 = "select * from jurusan_dim";
					...
					while (rs_tDBInput_6.next()) {
						...
						if (colQtyInRs_tDBInput_6 < 1) {
							...
							if (rs_tDBInput_6.getObject(1) != null) {
								row7.jurusan_key = rs_tDBInput_6.getInt(1);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
							}
						...
						if (colQtyInRs_tDBInput_6 < 2) {
							row7.kode_jurusan = null;
						} else {

							if (rs_tDBInput_6.getObject(2) != null) {
								row7.kode_jurusan = rs_tDBInput_6.getInt(2);
							} else {
								row7.kode_jurusan = null;
							}
						}
						if (colQtyInRs_tDBInput_6 < 3) {
							row7.nama_jurusan = null;
						} else {

							row7.nama_jurusan = routines.system.JDBCUtil
						...
						if (colQtyInRs_tDBInput_6 < 4) {
							...
							row7.fakultas = routines.system.JDBCUtil.getString(
						...
						row7_HashRow.jurusan_key = row7.jurusan_key;

						row7_HashRow.kode_jurusan = row7.kode_jurusan;

						row7_HashRow.nama_jurusan = row7.nama_jurusan;

						row7_HashRow.fakultas = row7.fakultas;
	...
	public static void main(String[] args) {
		final transaksi_fact transaksi_factClass = new transaksi_fact();

		int exitCode = transaksi_factClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = transaksi_fact.class
					.getClassLoader().getResourceAsStream(
							"skripsi/transaksi_fact_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = transaksi_fact.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : transaksi_fact");
		}
...
/************************************************************************************************
 * 170132 characters generated by Talend Open Studio for Big Data on the
 * September 28, 2018 1:21:04 PM ICT
 ************************************************************************************************/
