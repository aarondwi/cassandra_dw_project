			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						row2.fdtgl_pinjam = data_checker
								.computeDate(row1.fdtgl_pinjam);
						row2.fdtgl_batas = data_checker
								.computeDate(row1.fdtgl_batas);
						row2.fdtgl_kembali = data_checker
...
/************************************************************************************************
 * 175125 characters generated by Talend Open Studio for Big Data on the October
 * 16, 2018 11:26:34 AM ICT
 ************************************************************************************************/
