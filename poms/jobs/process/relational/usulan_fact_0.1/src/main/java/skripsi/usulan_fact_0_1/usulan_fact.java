...
public class usulan_fact implements TalendJob {
	...
	public static class loadStruct implements
		...
		public Double kode_status;

		public Double getKode_status() {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SKRIPSI_usulan_fact) {
				...
				try {
					...
					length = dis.readByte();
					if (length == -1) {
						this.kode_status = null;
					} else {
						this.kode_status = dis.readDouble();
					}
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				if (this.kode_status == null) {
					...
					dos.writeByte(0);
					dos.writeDouble(this.kode_status);
				}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String insert_tDBOutput_1 = "INSERT INTO \""
						...
						+ "\" (\"id_usul\",\"judul\",\"pengarang\",\"jenis_usul\",\"status\",\"penerbit_key\",\"tgl_key\",\"jurusan_key\") VALUES (?,?,?,?,?,?,?,?)";
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 8) {
							...
							if (rs_tDBInput_1.getObject(8) != null) {
								row1.kode_status = rs_tDBInput_1.getDouble(8);
							} else {
								row1.kode_status = null;
							}
						}
						...
						if (row1.jenis_usul != null) {
							row2.jenis_usul = row1.jenis_usul;
						} else {
							row2.jenis_usul = "u";
						}

						if (row1.kode_status != null) {
							row2.kode_status = row1.kode_status;
						} else {
							row2.kode_status = 1.0; // belum disetujui
						}

						// null penerbit is unknown
						if (row1.penerbit == null || row1.penerbit.equals("")) {
							row2.penerbit = "unknown";
						} else
							row2.penerbit = row1.penerbit;
						...
						try {
							// no null value here, no need to check
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							row3HashKey.penerbit = row2.penerbit;
						...
						if (tHash_Lookup_row3 != null
							...
							// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.penerbit = '"
							// + row3HashKey.penerbit + "'");
						} // G 071
						...
						{ // start of Var scope
							...
							load_tmp.jenis_usul = row2.jenis_usul;
							load_tmp.kode_status = row2.kode_status;
							load_tmp.penerbit_key = row3.penerbit_key;
						...
						if (load != null) {
							...
							if (load.jenis_usul == null) {
								...
								pstmt_tDBOutput_1.setString(4, load.jenis_usul);
							}

							if (load.kode_status == null) {
								pstmt_tDBOutput_1.setNull(5,
										java.sql.Types.DOUBLE);
							} else {
								pstmt_tDBOutput_1
										.setDouble(5, load.kode_status);
							}
							...
							if (load.penerbit_key == null) {
								...
								pstmt_tDBOutput_1.setInt(6, load.penerbit_key);
							}
							...
							if (load.date_key == null) {
								...
								pstmt_tDBOutput_1.setInt(7, load.date_key);
							}
							...
							if (load.jurusan_key == null) {
								...
								pstmt_tDBOutput_1.setInt(8, load.jurusan_key);
							}
	...
	public static class row3Struct implements
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime
						* result
						+ ((this.penerbit == null) ? 0 : this.penerbit
								.hashCode());
		...
		public boolean equals(Object obj) {
			...
			} else if (!this.penerbit.equals(other.penerbit))
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.kode_penerbit = readInteger(dis, ois);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeInteger(this.kode_penerbit, dos, oos);
		...
		public int compareTo(row3Struct other) {
			...
			returnValue = checkNullsAndCompare(this.penerbit, other.penerbit);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// inputs:(row3) outputs:()
				// linked node: tMap_1 - inputs:(row2,row3,row4,row5)
				// outputs:(load)
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							row3.penerbit_key = null;
						} else {

							if (rs_tDBInput_2.getObject(1) != null) {
								row3.penerbit_key = rs_tDBInput_2.getInt(1);
							} else {
								row3.penerbit_key = null;
							}
						}
						if (colQtyInRs_tDBInput_2 < 2) {
							row3.kode_penerbit = null;
						} else {

							if (rs_tDBInput_2.getObject(2) != null) {
								row3.kode_penerbit = rs_tDBInput_2.getInt(2);
							} else {
								row3.kode_penerbit = null;
							}
						}
						if (colQtyInRs_tDBInput_2 < 3) {
							...
							row3.penerbit = routines.system.JDBCUtil.getString(
						...
						row3_HashRow.penerbit_key = row3.penerbit_key;

						row3_HashRow.kode_penerbit = row3.kode_penerbit;

						row3_HashRow.penerbit = row3.penerbit;
...
/************************************************************************************************
 * 133584 characters generated by Talend Open Studio for Big Data on the
 * September 28, 2018 1:19:43 PM ICT
 ************************************************************************************************/
