			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				prepareStmt_tCassandraOutput_1 = connection_tCassandraOutput_1
						.prepare("INSERT INTO "
								...
								+ " (\"kode_buku\",\"kode_judul\",\"tanggal_input\",\"tanggal_datang\",\"unique_id\",judul,\"jenis_terbitan\",\"nama_koleksi\",\"kelompok_kategori\",\"status_sekarang\",penerbit) VALUES (?,?,?,?,?,?,?,?,?,?,?)");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						 ...
						 * row2.fckd_jnskol=row1.fckd_jnskol; } else {
						 * row2.fckd_jnskol="none"; }
						 * 
						 * try{ row2.status=row1.status.toLowerCase(); }
						 * catch(Exception e){ row2.status="b"; }
						 * 
						 * //error here means wrong input data, e.g. 15:37.5 or
						 * is null SimpleDateFormat dt=new
						 * SimpleDateFormat("MM/dd/yyyy");
						 * 
						 * try{
						 * row2.fdtgl_input=dt.parse(row1.fdtgl_input.split(
						 * " ")[0]); } catch(Exception
						 * e){row2.fdtgl_input=dt.parse("01/01/0001");}
						 * 
						 * try{
						 * row2.tgl_dtg=dt.parse(row1.tgl_dtg.split(" ")[0]); }
						 * catch(Exception
						 * e){row2.tgl_dtg=dt.parse("01/01/0001");}
						 */
...
/************************************************************************************************
 * 257342 characters generated by Talend Open Studio for Big Data on the October
 * 13, 2018 12:43:32 PM ICT
 ************************************************************************************************/
