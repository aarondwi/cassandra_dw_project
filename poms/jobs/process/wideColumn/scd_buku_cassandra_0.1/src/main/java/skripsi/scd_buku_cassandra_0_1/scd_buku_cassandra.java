			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				prepareStmt_tCassandraOutput_2 = connection_tCassandraOutput_2
						.prepare("INSERT INTO "
								...
								+ " (\"nama_jurusan\",\"tahun_ajaran\",\"tgl_pinjam\",\"kelompok_kategori\",\"nama_koleksi\",\"unique_id\",\"tanggal_ganti_status\",\"status_lama\",\"status_sekarang\") VALUES (?,?,?,?,?,?,?,?,?)");
				...
				columns_tCassandraOutput_2.add("tahun_ajaran");

				columns_tCassandraOutput_2.add("tgl_pinjam");

				columns_tCassandraOutput_2.add("kelompok_kategori");
				...
				com.datastax.driver.core.ResultSet rs_tCassandraInput_2 = connection_tCassandraInput_2
						.execute("select nama_jurusan, tahun_ajaran, tgl_pinjam, kelompok_kategori, nama_koleksi, unique_id, status_sekarang,kode_buku from skripsi.cf_transaksi_jurusan_kategori where kode_buku in ("
								+ globalMap.get("ids_str")
								+ ") allow filtering");
				...
				for (com.datastax.driver.core.Row row_tCassandraInput_2 : rs_tCassandraInput_2) {
					...
					if (row_tCassandraInput_2.isNull("\"tahun_ajaran\"")) {
						row6.tahun_ajaran = null;
					} else {

						row6.tahun_ajaran = row_tCassandraInput_2
								.getString("\"tahun_ajaran\"");
					...
					if (row_tCassandraInput_2.isNull("\"kelompok_kategori\"")) {
						row6.kelompok_kategori = null;
					} else {

						row6.kelompok_kategori = row_tCassandraInput_2
								.getString("\"kelompok_kategori\"");
					...
					row7.tahun_ajaran = row6.tahun_ajaran;
					row7.tgl_pinjam = row6.tgl_pinjam;
					row7.kelompok_kategori = row6.kelompok_kategori;
					...
					if (row7.tahun_ajaran == null) {
						boundStmt_tCassandraOutput_2.setToNull(1);
					} else {
						boundStmt_tCassandraOutput_2.setString(1,
								row7.tahun_ajaran);
					}
...
/************************************************************************************************
 * 148469 characters generated by Talend Open Studio for Big Data on the October
 * 16, 2018 1:03:46 PM ICT
 ************************************************************************************************/
